...
class MsvcPlatform extends WindowsPlatform {
    ...
    runInstaller(tool, args, instDir) {
        const _super = Object.create(null, {
            runInstallerBin: { get: () => super.runInstallerBin }
        });
        return __awaiter(this, void 0, void 0, function* () {
            yield _super.runInstallerBin.call(this, tool, args);
            yield this.prepareVcTools(instDir);
        });
    }
    qmakeName() {
        return "qmake-vc.bat";
    ...
    prepareVcTools(instDir) {
        return __awaiter(this, void 0, void 0, function* () {
            let vcTarget;
            let vcPlatform = null;
            const vcVersion = "-vcvars_ver=14.16";
            switch (this.platform) {
                case "winrt_x64_msvc2017":
                    vcPlatform = "uwp";
                case "msvc2017_64":
            ...
            args.push(vcVersion);
            yield fs_1.promises.writeFile(path.join(instDir, this.version, this.platform, "bin", "qmake-vc.bat"), `@echo off
