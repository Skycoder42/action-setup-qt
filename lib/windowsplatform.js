...
class MsvcPlatform extends WindowsPlatform {
    runInstaller(tool, args, instDir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield fs_1.promises.writeFile(makePath, "@nmake");
            if (this.platform.includes("winrt"))
                yield fs_1.promises.symlink("C:\\Program Files (x86)\\Microsoft Visual Studio\\2017", "C:\\Program Files (x86)\\Microsoft Visual Studio\\2019", 'dir');
        });
    }
    installPlatform() {
