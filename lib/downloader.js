...
class Downloader {
    ...
    addSource(url, deep) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const filtered = (_a = update.Updates.PackageUpdate) === null || _a === void 0 ? void 0 : _a.filter(x => x.Name.endsWith("." + this._platform));
            core.debug(`Downloaded ${(_b = filtered) === null || _b === void 0 ? void 0 : _b.length} valid module configurations from ${url}`);
            (_c = filtered) === null || _c === void 0 ? void 0 : _c.reduce((map, x) => map.set(this.stripPackageName(x.Name), new package_1.default(x, sourceUrl)), this._packages);
        });
    }
    addToolSource(url, type) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!Array.isArray(update.Updates.PackageUpdate))
                    update.Updates.PackageUpdate = [update.Updates.PackageUpdate];
                core.debug(`Downloaded ${(_a = update.Updates.PackageUpdate) === null || _a === void 0 ? void 0 : _a.length} valid module configurations from ${url}`);
