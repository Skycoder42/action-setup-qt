...
function getQt(version, platform, pPackages, gPackages, iArgs) {
    return __awaiter(this, void 0, void 0, function* () {
        // check cache
        let toolPath = null; //tc.find('qt', version, platform);
        if (!toolPath) {
            // download, extract, cache
            toolPath = yield acquireQt(version, platform, pPackages, gPackages, iArgs);
...
exports.getQt = getQt;
function acquireQt(version, platform, pPackages, gPackages, iArgs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield fs_1.promises.writeFile(scriptPath, qtScript.generateScript(installPath, version, platform, pPackages, gPackages));
        }
        catch (error) {
            console.log(error);
            throw `Failed to download version ${version}: ${error.message}`;
