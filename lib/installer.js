...
class Installer {
    ...
    getQt(packages, iArgs, cachedir) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!toolPath) {
                ...
                toolPath = yield this.acquireQt(packages, iArgs, cachedir);
            }
            else {
            ...
            const iPath = this.platform.setupInstallDir(toolPath);
    ...
    acquireQt(packages, iArgs, cachedir) {
        return __awaiter(this, void 0, void 0, function* () {
            // download the installer
            const downloadPath = yield tc.downloadTool(`http://download.qt.io/official_releases/online_installers/${this.platform.installerName()}`);
            ...
            let resDir;
            if (cachedir) {
                yield io.mv(path.join(installPath, this.version, this.platform.platform), cachedir);
                resDir = path.resolve(cachedir);
            }
            else
                resDir = yield tc.cacheDir(path.join(installPath, this.version, this.platform.platform), 'qt', this.version, this.platform.platform);
