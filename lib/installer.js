...
let Installer = /** @class */ (() => {
    class Installer {
        constructor(version, platform) {
            this._tempDir = this.initTempDir(os_1.default.platform());
            ...
            switch (os_1.default.platform()) {
                ...
                case "darwin":
                    ...
                    break;
                default:
                    throw `Install platform ${os_1.default.platform()} is not supported by this action`;
            }
        ...
        acquireQt(packages, deepSrc, flatSrc) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const installPath = path_1.default.join(this._tempDir, 'qt');
                yield this._downloader.installTo(installPath);
                const dataPath = path_1.default.join(installPath, this._version.toString(), this._platform.platform);
                // move tools
    ...
    Installer.CacheDir = path_1.default.join(".cache", "qt");
    return Installer;
})();
