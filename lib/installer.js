...
function acquireQt(version, platform, pPackages, gPackages) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield fs_1.promises.mkdir(tempDirectory);
        ...
        if (osPlat == "win32") {
            ...
            yield ex.exec(downloadPath, ["--script", scriptPath, "--addRepository", "https://install.skycoder42.de/qtmodules/linux_x64", "--verbose"], options);
        }
