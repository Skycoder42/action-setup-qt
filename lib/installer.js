...
class Installer {
        ...
        switch (os.platform()) {
            ...
            case "win32":
                if (platform.includes("mingw"))
                    ...
                    this.platform = new windowsplatform_1.WindowsPlatform(platform);
                break;
            case "darwin":
    ...
    acquireQt(packages, iArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // add qdep prf file
            const qmakePath = path.join(installPath, this.version, this.platform.platform, "bin", this.platform.qmakeName(installPath));
