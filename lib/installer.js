...
function acquireQt(version, platform, packages, iArgs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Run the installer
        //
        let installPath = osPlat == "win32" ? path.join(process.env['USERPROFILE'] || 'C:\\', 'qt') : path.join(tempDirectory, 'qt');
        ...
        const qmakePath = path.join(installPath, version, platform, "bin", "qmake");
