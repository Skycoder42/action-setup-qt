...
const wasmplatform_1 = __importDefault(require("./platforms/wasmplatform"));
...
class Installer {
        ...
        switch (os_1.platform()) {
            case "linux":
                if (this._config.platform.includes("android")) {
                    ...
                    this._platform = new wasmplatform_1.default(this._config.platform);
                }
                else {
    ...
    generateCMakeArgs(qtDir, instDir) {
        ...
        core_1.exportVariable("CMAKE_PREFIX_PATH", qtDir);
        core_1.exportVariable("CMAKE_FIND_ROOT_PATH", qtDir);
        // TODO use https://www.npmjs.com/package/shell-escape
        core_1.setOutput("cmakeArgs", "'" + cmakeArgs.join("' '") + "'");
    }
}
